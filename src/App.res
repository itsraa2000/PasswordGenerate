...
let make = () => {
  ...
  let (password, setPassword) = React.useState( _ => "saiudoacjsa");
            ...
            <div className="flex flex-col justify-between m-4">
              <div className="flex flex-col pb-8">
                <div className="flex justify-between items-center pb-3">
                  ...
                  <h2 className="flex items-center text-maingreen text-2xl">{React.string(passwordLength)}</h2>
                </div>
                <div className="flex">
                  <input id="passwordLength" type_="range" min="8" max="36" onChange={onLengthChange} value=passwordLength className="w-full h-2 bg-maindark rounded-lg appearance-none cursor-pointer glow-1 accent-mainlight" />
                </div>
              </div>
                  ...
                  <div className="flex flex-col">
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex space-x-2 p-3">
                        <div className="h-8 w-[10px] bg-maindark border-sublight border-solid border-box border-2"></div>
                        <div className="h-8 w-[10px] bg-maindark border-sublight border-solid border-box border-2"></div>
                        <div className="h-8 w-[10px] bg-maindark border-sublight border-solid border-box border-2"></div>
                        <div className="h-8 w-[10px] bg-maindark border-sublight border-solid border-box border-2"></div>
                      </div>
